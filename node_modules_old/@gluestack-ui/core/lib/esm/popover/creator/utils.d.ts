...
export declare const applyCrossOffsetToArrowStyle: (arrowStyle: Record<string, any>, actualPlacement: string | undefined, crossOffset: number) => {
    [x: string]: any;
};
/** Nudge along the main axis on the edge props from `getArrowStyles`. */
export declare const applyOffsetToArrowEdgeStyles: (edgeStyles: Record<string, any>, actualPlacement: string | undefined, offset: number) => {
    [x: string]: any;
};
export {};
