...
export interface ICalendarComponentType<RootProps, HeaderProps, HeaderPrevButtonProps, HeaderNextButtonProps, HeaderTitleProps, HeaderMonthSelectProps, HeaderYearSelectProps, WeekDaysHeaderProps, WeekDayProps, BodyProps, GridProps, WeekProps, DayProps, DayTextProps, DayIndicatorProps, WeekNumberProps, FooterProps> extends React.ForwardRefExoticComponent<RootProps & React.RefAttributes<any>> {
