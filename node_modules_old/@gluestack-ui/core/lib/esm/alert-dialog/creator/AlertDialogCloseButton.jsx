...
// @ts-ignore
const AlertDialogCloseButton = (StyledAlertDialogCloseButton) => forwardRef((_a, ref) => {
    ...
    const { 
    // _icon,
    onPressIn, onPressOut, onHoverIn, onHoverOut, onFocus, onBlur } = props, resolvedProps = __rest(props, ["onPressIn", "onPressOut", "onHoverIn", "onHoverOut", "onFocus", "onBlur"]);
    const { handleClose } = React.useContext(AlertDialogContext);
    return (<StyledAlertDialogCloseButton role="button" ref={ref} onPressIn={composeEventHandlers(onPressIn, pressableProps.onPressIn)} onPressOut={composeEventHandlers(onPressOut, pressableProps.onPressOut)} 
    // @ts-ignore - web only
    ...
    dataSet={{
        ...
        }} disabled={isDisabled} {...resolvedProps}>
          {children}
        </StyledAlertDialogCloseButton>);
});
export default AlertDialogCloseButton;
//# sourceMappingURL=AlertDialogCloseButton.jsx.map