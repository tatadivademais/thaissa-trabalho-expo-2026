import type { FlatList as RNFlatList, PressableProps, SectionList as RNSectionList, VirtualizedList } from 'react-native';
...
export type IActionsheetComponentType<ActionsheetProps, BackdropProps, ItemProps, ItemTextProps, DragIndicatorProps, IndicatorWrapperProps, ContentProps, ScrollViewProps, VirtualizedListProps, FlatListProps, SectionListProps, SectionHeaderTextProps, IconProps> = React.ForwardRefExoticComponent<React.RefAttributes<ActionsheetProps> & React.PropsWithoutRef<ActionsheetProps & IActionsheetProps>> & {
    ...
    VirtualizedList: React.ForwardRefExoticComponent<React.PropsWithoutRef<VirtualizedListProps> & React.RefAttributes<VirtualizedList<any>>>;
    FlatList: React.ForwardRefExoticComponent<React.PropsWithoutRef<FlatListProps> & React.RefAttributes<RNFlatList>>;
    SectionList: React.ForwardRefExoticComponent<React.PropsWithoutRef<SectionListProps> & React.RefAttributes<RNSectionList>>;
